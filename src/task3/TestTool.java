...
public class TestTool {
	...
	public boolean BFS_FordFulkerson_with_order1(TestResidualGraph G, Vertex s, Vertex t) {
		Iterator<Vertex> GVit = G.v.values().iterator();
		while(GVit.hasNext()) {
			Vertex GV = GVit.next();
			G.v.get(GV.getId()).visited = false;
		...
		while(!Q.isEmpty()) {
			...
			TestAscending_VertexName Ascending = new TestAscending_VertexName(G);
	...
	public boolean BFS_FordFulkerson_with_order2(TestResidualGraph G, Vertex s, Vertex t) {
		Iterator<Vertex> GVit = G.v.values().iterator();
		while(GVit.hasNext()) {
			Vertex GV = GVit.next();
			G.v.get(GV.getId()).visited = false;
		...
		while(!Q.isEmpty()) {
			...
			// Problem 4C - Sort G.adj_list.get(uu.getId()) 
			//System.out.println("====================== G.adj_list.get(uu.getId()) =================== ");
			TestAscending_ResidualCapacity Ascending = new TestAscending_ResidualCapacity(G,uu);
			Collections.sort(G.adj_list.get(uu.getId()), Ascending);
			/*
			Iterator<Vertex> Dubug_GadjOfu = G.adj_list.get(uu.getId()).iterator();
			while(Dubug_GadjOfu.hasNext()) {
	...
	public double FordFurkerson_order1(TestResidualGraph G, Vertex source, Vertex sink) {
		double max_flow = 0;
	...
	public double FordFurkerson_order2(TestResidualGraph G, Vertex source, Vertex sink) {
		double max_flow = 0;
...
class TestAscending_ResidualCapacity implements Comparator<Vertex>{
	
	public TestResidualGraph G;
	public Vertex u;
	
	TestAscending_ResidualCapacity(TestResidualGraph _G, Vertex _u){
		G = _G;
		u = _u;
	}
...
class TestAscending_VertexName implements Comparator<Vertex>{
	public TestResidualGraph G;
	TestAscending_VertexName(TestResidualGraph _G){
		G = _G;
	}
	@Override
	public int compare(Vertex v1, Vertex v2) {
